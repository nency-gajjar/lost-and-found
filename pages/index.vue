<template>
  <div>
    <div class="wrapper border-t min-h-max">
      <div class="pt-4 gradient w-full">
        <div class="container mx-auto px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <div class="flex">
              ...
              <div class="qr-code">
                <img class="bg-white rounded-lg p-4" src="@/assets/images/item-details-qr.png" alt="qr code image" />
                <p class="text-white text-sm mt-4">Scan this QR to Add new lost item</p>
          ...
          <div class="w-full md:w-3/5 text-center pb-10">
            <img class="w-full md:w-4/5 mx-auto z-50" src="https://www.tailwindtoolbox.com/templates/hero.png">
          </div>
        </div>
...
*/
.wrapper {
  @apply flex justify-center text-center mx-auto;
}
...
.sliderCard{
  @apply flex justify-center items-center flex-col bg-white mx-5 p-5 rounded-lg;
