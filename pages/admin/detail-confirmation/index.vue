<template>
  <div class="wrapper-admin">
    <div class="w-full" v-if="!isLoadingItemDetails || Object.keys(itemDetails).length > 0">
              ...
              <div class="flex sm:items-center items-start mt-3 flex-wrap md:flex-nowrap sm:flex-row flex-col" :class="venuePhoneValidationMessage && 'pt-5'">
                ...
                <div class="text-gray-600 text-left md:w-7/12 sm:w-6/12 w-full">
                  <div
                    ...
                    :class="[
                      isEmployeeMobileNoFormatValid && '!mt-0',
                  ...
                  <div
                    v-if="!isEmployeeMobileNoFormatValid && employeePhoneValidationMessage"
                  ...
                  <template v-if="!itemDetails.item_status">
                    ...
                    <div class="flex sm:items-center items-start mt-3 flex-wrap md:flex-nowrap sm:flex-row flex-col">
                      ...
                      >
                        <div
                          class="block relative box-content h-12"
                          :class="!isReceiverMobileNoFormatValid && 'error'"
                        >
                          <vue-tel-input
                            class="
                              relative
...
export default {
  ...
  methods: {
    changedPound(){
      this.itemDetails.weight_ounces = Number((Number(this.itemDetails.weight_pounds) * 16).toFixed(1));
    },
    changedOunces(){
